...
public class AddEmployeeSteps extends CommonMethods {
	...
	public void user_enters_employee_first_name_and_last_name() {
		sendText(addEmployee.firstNameBox, "Lionel");
		sendText(addEmployee.lastNameBox, "Messi");
	}
	...
	public void user_enters_employee_and(String first, String middle, String last) {
		sendText(addEmployee.firstNameBox, first);
		sendText(addEmployee.middleNameBox, middle);
		sendText(addEmployee.lastNameBox, last);
	}
	...
	public void user_enters_employee_details(DataTable table) {
		...
		for (Map<String, String> employee : employeeList) {
			...
			sendText(addEmployee.firstNameBox, fName);
			sendText(addEmployee.middleNameBox, mName);
			sendText(addEmployee.lastNameBox, lName);
